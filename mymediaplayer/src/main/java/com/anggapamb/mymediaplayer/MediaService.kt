...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "com.anggapamb.mysound.mediaservice.create"
        const val ACTION_DESTROY = "com.anggapamb.mysound.mediaservice.destroy"
    ...
    private fun init() {
        ...
        val afd = applicationContext.resources.openRawResourceFd(R.raw.lathi)
        try {
